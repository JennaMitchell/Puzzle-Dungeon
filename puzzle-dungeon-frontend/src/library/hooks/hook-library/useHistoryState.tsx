// useHistoryState is similar to useState or useReducer in that it allows you to manage state in a React component.
// The difference is useHistoryState comes with some extra functionality that keeps track of the history of the changes made to the state.
