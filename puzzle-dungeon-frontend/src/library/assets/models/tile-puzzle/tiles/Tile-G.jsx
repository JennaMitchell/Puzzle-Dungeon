...
export function TileG({
  ...
  const { nodes, materials } = useGLTF("/models/tile-G.glb");
  ...
  return (
    ...
    >
      <mesh
        geometry={nodes["tile-puzzle-G_v1_1"].geometry}
        material={materials["Mesh.002"]}
        ref={modelRef}
      >
        {elementClicked && <Outlines thickness={0.45} color="white" />}
      </mesh>
      <mesh
        geometry={nodes["tile-puzzle-G_v1_2"].geometry}
...
useGLTF.preload("/models/tile-G.glb");
